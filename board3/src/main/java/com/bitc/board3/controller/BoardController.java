...
public class BoardController {
    // RESTfull이란 : 자원의 이름으로 구분하여 해당 자원의 정보를 주고 받는 것
    ...
    // 전체 URL 생성 방법 :
    // 서버 URL: 포트번호/기본 주소/추가주소 or 게시물번호/접근하고자하는 게시물번호
    ...
    // @PathVariable : 지정한 자원 이름과 Controller가 가지고 있는 메소드의 매개변수명을 매칭시켜주는 어노테이션
