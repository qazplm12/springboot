...
// 스프링 6(스프링부트 3)부터 javax -> jakarta로 변경됨
...
// Mybatis 사용 시의 DTO 클래스 역할도 하고 있음
...
public class Member {
    ...
    // 옵션이 4가지 존재함
        ...
        // SEQUENCE : 데이터 베이스 시퀀스를 사용하여 기본키를 설정 (oracle에서 사용함)
        // TABLE : 키 생성 테이블을 사용함
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private long idx;

    // @Column : 지정한 필드에 데이터베이스의 컬럼과 연동시키는 어노테이션
